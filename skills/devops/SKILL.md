...
metadata:
  ...
  hermes:
    tags: ["devops", "hosting", "deployment", "cicd", "github-actions", "domains", "dns", "security", "monitoring", "alerting", "incident-response", "uptime", "infrastructure-as-code"]
  ...
  openclaw:
    category: agency-delivery
    suggested_skills: ["git", "webdev", "automation", "code-review"]
    primary_triggers: ["deploy this", "set up hosting", "ci/cd pipeline", "configure domain", "dns", "harden security", "add monitoring", "incident postmortem"]
    requires_tools: ["bash", "view_file", "write_to_file", "replace_file_content", "run_command", "grep_search"]
